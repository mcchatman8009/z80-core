#ifndef Z80_CORE_CPUMNEMONICTABLES_H
#define Z80_CORE_CPUMNEMONICTABLES_H

#include <string>

//@formatter:off
std::string baseOpCodeTable[256] =
    {
...
std::string indexOpCodeTable[256] =
    {
        "?"			,"?"  		,"?"			,"?"        	,"?"       	,"?"       	,"?"      	,"?",
        "?"      	,"ADD I,BC" ,"?"       		,"?"       		,"?"       	,"?"       	,"?"      	,"?",
        "?"      	,"?"       	,"?"       		,"?"			,"?"       	,"?"       	,"?"      	,"?",
...
#endif //Z80_CORE_CPUMNEMONICTABLES_H
